    ...
    <header>
        <nav class="py-6 px-6 bg-surface-0 dark:bg-surface-900 w-full flex items-center justify-between fixed top-0 z-50 h-[80px]" aria-label="Global">
            <RouterLink to="/" class="flex items-center" href="#">
                ...
                <span class="text-surface-900 dark:text-surface-0 font-medium text-xl w-16 leading-normal mr-20">E-Shop</span>
            </RouterLink>
            ...
            <div class="flex gap-4">
                ...
                <div class="flex border-t lg:border-t-0 border-surface p-3 gap-4" v-if="!validUser">
                    <router-link to="/user/login" class="relative group">
                        <i class="pi pi-sign-in hover:scale-110" style="font-size: 2em" rounded></i>
                        <span class="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-green-400 text-white text-sm rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity"> Login</span>
                    </router-link>
                    <router-link to="/user/registration" class="relative group">
                        <i class="pi pi-user-edit hover:scale-110" style="font-size: 2em" label="Register" severity="contrast" rounded></i>
                        <span class="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-green-400 text-white text-sm rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity"> Registration </span>
                    </router-link>
                </div>
                <div v-else>
