...
<template>
    ...
    >
        <div class="mx-6 md:mx-10 mt-0 md:mt-6 col-span-2 sm:col-span-1">
            <h1 class="text-[6vw] sm:text-[3vw] font-bold text-gray-900 leading-tight"><span class="font-light block">Shop Quality, Style & Deals!</span>Find exclusive items at unbeatable prices.</h1>
            <p class="font-normal text-[2vw] leading-normal md:mt-4 text-gray-700">"Shop Electronics" | "Shop Fashion" | "Shop Home Goods"</p>
