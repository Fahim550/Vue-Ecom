...
const createAccount = async () => {
    ...
    (state.name = ''), (state.email = ''), (state.password = ''), (state.phone = ''), (state.address = ''), (state.birthdate = '');
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="name1" type="text" placeholder="Email Name" class="w-full md:w-[30rem] mb-8" v-model="state.name" />
                        <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                        <InputText id="email1" type="text" placeholder="Email address" class="w-full md:w-[30rem] mb-8" v-model="state.email" />
                        ...
                        <InputText id="phone" type="phone" placeholder="Phone" class="w-full md:w-[30rem] mb-8" v-model="state.phone" />
                        <label for="address" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Address</label>
                        <InputText id="address" type="address" placeholder="Address" class="w-full md:w-[30rem] mb-8" v-model="state.address" />
                        <label for="DOB" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Date of Birth</label>
                        <InputText id="DOB" type="date" placeholder="Date of Birth" class="w-full md:w-[30rem] mb-8" v-model="state.phone" />
